...
// 每新建一个实例, 就会新建一个 meow 方法, 既无必要要, 也浪费系统资源, meow 完全应该共享(所有的 meow 方法都是同样的行为)
...
var y = new x.constructor(); // y 基于 Constr 构造
...
/*
  ...
  判断值的类型, instanceof 只能用于对象, 不适用原始类型的值
*/
function Vehicle() {}
var v = new Vehicle();
